...
//  ZLPhotoBrowser
//
//  Created by huipeng on 08/10/2020.
...
/**
 原项目 git 地址：https://github.com/longitachi/ZLPhotoBrowser
 本项目 git 地址：https://github.com/huipengo/ZLPhotoBrowser
 */


@interface WBViewController () <UITextFieldDelegate>
...
- (void)initCollectionView
{
    ...
    [self.collectionView registerClass:NSClassFromString(@"WBImageCell") forCellWithReuseIdentifier:@"WBImageCell"];
}
...
{
    WBImageCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"WBImageCell" forIndexPath:indexPath];
